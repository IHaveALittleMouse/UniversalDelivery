...
public class DisplayUtil {
  ...
  public static DisplayMetrics getDisplayMetrics(Context context) {
    ...
    //DisplayMetrics{density=1.5, width=480, height=854, scaledDensity=1.5, xdpi=160.421,
	  // ydpi=159.497}
    //DisplayMetrics{density=2.0, width=720, height=1280, scaledDensity=2.0, xdpi=160.42105,
	  // ydpi=160.15764}
