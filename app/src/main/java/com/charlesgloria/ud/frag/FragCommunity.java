...
import com.charlesgloria.ud.atys.AtyChat;
...
//                .transition.switch_still);
      ...
      public void onListItemLongClicked(EaseUser user) {
        ...
        dialogChoice(user.getUsername(), Config.getCachedPreference(getActivity(),
            Config.KEY_HX_NICKNAME + user.getUsername()));
      }
    });
...
//                tv1.setTextColor(getResources().getColor(R.color.white));
  ...
  private Map<String, EaseUser> getContacts() {
    ...
    new DownloadHXFriends(Config.getCachedPhoneNum(getActivity()),
        new DownloadHXFriends.SuccessCallback() {
      @Override
