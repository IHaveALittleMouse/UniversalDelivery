          ...
          case Config.RESULT_STATUS_SUCCESS:
            if (successCallback != null) {
              ...
              for (int i = 0; i < commentsJsonArray.length(); i++) {
                ...
                comments.add(new Comment(commentObj.getString(Config.KEY_CONTENT),
                    commentObj.getString(Config.KEY_PHONE_MD5)));
              }

//							successCallback.onSuccess(jsonObject.getString(Config.KEY_MSG_ID),
//							jsonObject.getInt(Config.KEY_PAGE), jsonObject.getInt(Config
//							.KEY_PERPAGE), comments);
